...
namespace daleWebAuth.helpers
{
    public static class FontAwesome
    {
        ...
        public const string EqualsCode = "\uf52c";
        ...
        // for Visit Header
        public static string ArchiveSecondary = UnicodeToCharacter("10f187");
        public static string TimesHexagonSecondary = UnicodeToCharacter("10f2ee");
        public static string CalculatorSecondary = UnicodeToCharacter("10f1ec");
        public static string ToolsSecondary = UnicodeToCharacter("10f7d9");
        public static string UndoSecondary = UnicodeToCharacter("10f0e2");


        // for Estimate Header
        public static string ThumbsUpSecondary = UnicodeToCharacter("10f164");
        public static string ThumbsDownSecondary = UnicodeToCharacter("10f165");
        public static string PaperPlanSecondary = UnicodeToCharacter("10f1d8");

        // for Job Header
        public static string FlagCheckeredSecondary = UnicodeToCharacter("10f11e");
        public static string UsdCircleSecondary = UnicodeToCharacter("10f2e8");
        public static string PauseSecondary = UnicodeToCharacter("10f04c");
        public static string PlaySecondary = UnicodeToCharacter("10f04b");
        public static string TruckSecondary = UnicodeToCharacter("10f0d1");

        // for invoice Header
        public static string DownloadSecondary = UnicodeToCharacter("10f019");
        public static string PrintSecondary = UnicodeToCharacter("10f02f");

        // for customer and address section
        public static string MobileAltSecondary = UnicodeToCharacter("10f3cd");
        public static string SmsSecondary = UnicodeToCharacter("10f7cd");
        public static string EnvelopeSecondary = UnicodeToCharacter("10f0e0");
        public static string MapMarkerAltSecondary = UnicodeToCharacter("10f3c5");

        // for dashboard
        public static string ExclamationCircleSecondary = UnicodeToCharacter("10f06a");
        public static string DoorOpenSecondary = UnicodeToCharacter("10f52b");
        public static string CalculatorAltSecondary = UnicodeToCharacter("10f64c");
        public static string BriefcaseSecondary = UnicodeToCharacter("10f0b1");
        public static string FileInvoiceDollarSecondary = UnicodeToCharacter("10f571");
        public static string GlobeSecondary = UnicodeToCharacter("10f0ac");
        public static string UserClockSecondary = UnicodeToCharacter("10f4fd");
        public static string EyeSecondary = UnicodeToCharacter("10f06e");
        public static string CalendarDaySecondary = UnicodeToCharacter("10f783");

        // for tabs
        public static string TagsSecondary = UnicodeToCharacter("10f02c");
        public static string HeartRateSecondary = UnicodeToCharacter("10f5f8");
        public static string PencilSecondary = UnicodeToCharacter("10f040");

        // for customer detail page
        public static string HistorySecondary = UnicodeToCharacter("10f1da");
        public static string StoreAltSecondary = UnicodeToCharacter("10f54f");
        public static string BellSecondary = UnicodeToCharacter("10f0f3");
        public static string ChartPieAltSecondary = UnicodeToCharacter("10f64e");
        public static string UserSecondary = UnicodeToCharacter("10f007");
        public static string MapMarkerPlusSecondary = UnicodeToCharacter("10f60a");

        // for detail pages
        public static string PencilAltSecondary = UnicodeToCharacter("10f303");
        public static string UserPlusSecondary = UnicodeToCharacter("10f234");
        public static string CalendarPlusSecondary = UnicodeToCharacter("10f271");
        public static string TasksSecondary = UnicodeToCharacter("10f0ae");
        public static string PlusSecondary = UnicodeToCharacter("10f067");
        public static string SearchLocationSecondary = UnicodeToCharacter("10f689");

        // for get paid page
        public static string BadgeCheckSecondary = UnicodeToCharacter("10f336");
        public static string DoNotEnterSecondary = UnicodeToCharacter("10f5ec");

        // for side menu page
        public static string TachometerAltSecondary = UnicodeToCharacter("10f3fd");
        public static string SignOutAltAltSecondary = UnicodeToCharacter("10f2f5");
        public static string QuestionSecondary = UnicodeToCharacter("10f128");
        public static string InfoCircleSecondary = UnicodeToCharacter("10f05a");

        // for add signature page
        public static string SyncAltSecondary = UnicodeToCharacter("10f2f1");

        // for time tracking pages
        public static string ArrowCircleLeftSecondary = UnicodeToCharacter("10f0a8");
        public static string ArrowCircleRightSecondary = UnicodeToCharacter("10f0a9");

        // for notes
        public static string PaperclipSecondary = UnicodeToCharacter("10f0c6");

        public static string CommentsSecondary = UnicodeToCharacter("10f086");

        private static string UnicodeToCharacter(string SecondaryIconUnicode)
        {
            int code = 0;
            bool success = int.TryParse(SecondaryIconUnicode, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out code);
            if (success)
                return char.ConvertFromUtf32(code);
            return SecondaryIconUnicode;
        }
    }
}
